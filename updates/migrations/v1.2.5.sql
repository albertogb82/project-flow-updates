...
VALUES ('p-pf', 'ProjectFlow Core', 'PF', 'Proyecto principal de desarrollo', 'Target', '#3c8af6', '', 'Alberto García', '"2026-04-19T10:15:54.001Z"'::jsonb, 'itss-default', 'ws-default', 'its-default', 'ps-default', NULL, NULL, 'ls-default')
...
INSERT INTO public.projects ("id", "name", "key", "description", "icon", "icon_color", "custom_icon_url", "owner", "created_at", "issue_type_screen_scheme_id", "workflow_scheme_id", "issue_type_scheme_id", "permission_scheme_id", "category", "deleted_at", "link_scheme_id")
VALUES ('proj-1778145251135', 'Support', 'SUPP', 'soporte', 'FolderKanban', '#3b82f6', '', 'Alberto García', '"2026-05-07T09:14:11.146Z"'::jsonb, 'itss-default', 'ws-default', 'its-default', 'ps-default', 'Client Support', NULL, 'ls-default')
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "key" = EXCLUDED."key", "description" = EXCLUDED."description", "icon" = EXCLUDED."icon", "icon_color" = EXCLUDED."icon_color", "custom_icon_url" = EXCLUDED."custom_icon_url", "owner" = EXCLUDED."owner", "created_at" = EXCLUDED."created_at", "issue_type_screen_scheme_id" = EXCLUDED."issue_type_screen_scheme_id", "workflow_scheme_id" = EXCLUDED."workflow_scheme_id", "issue_type_scheme_id" = EXCLUDED."issue_type_scheme_id", "permission_scheme_id" = EXCLUDED."permission_scheme_id", "category" = EXCLUDED."category", "deleted_at" = EXCLUDED."deleted_at", "link_scheme_id" = EXCLUDED."link_scheme_id";
INSERT INTO public.projects ("id", "name", "key", "description", "icon", "icon_color", "custom_icon_url", "owner", "created_at", "issue_type_screen_scheme_id", "workflow_scheme_id", "issue_type_scheme_id", "permission_scheme_id", "category", "deleted_at", "link_scheme_id")
VALUES ('proj-crm', 'CRM Accounts & Opportunities', 'CRM', 'CRM Project for managing client accounts and sales opportunities.', 'FolderKanban', '#10b981', '', 'Alberto García', '"2026-05-26T14:57:05.603Z"'::jsonb, 'itss-crm', 'ws-crm', 'its-crm', 'ps-default', 'CRM', NULL, 'ls-default')
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "key" = EXCLUDED."key", "description" = EXCLUDED."description", "icon" = EXCLUDED."icon", "icon_color" = EXCLUDED."icon_color", "custom_icon_url" = EXCLUDED."custom_icon_url", "owner" = EXCLUDED."owner", "created_at" = EXCLUDED."created_at", "issue_type_screen_scheme_id" = EXCLUDED."issue_type_screen_scheme_id", "workflow_scheme_id" = EXCLUDED."workflow_scheme_id", "issue_type_scheme_id" = EXCLUDED."issue_type_scheme_id", "permission_scheme_id" = EXCLUDED."permission_scheme_id", "category" = EXCLUDED."category", "deleted_at" = EXCLUDED."deleted_at", "link_scheme_id" = EXCLUDED."link_scheme_id";
...
VALUES ('tab-1776597062804-ectgm', 'screen-1776597053411', 'General', 0, '"2026-04-19T11:11:02.804Z"'::jsonb)
...
INSERT INTO public.screen_tabs ("id", "screen_id", "name", "tab_order", "created_at")
VALUES ('tab-1776597863111-mxgvc', 'screen-1776597528025', 'General', 0, '"2026-04-19T11:24:23.117Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "screen_id" = EXCLUDED."screen_id", "name" = EXCLUDED."name", "tab_order" = EXCLUDED."tab_order", "created_at" = EXCLUDED."created_at";
INSERT INTO public.screen_tabs ("id", "screen_id", "name", "tab_order", "created_at")
VALUES ('tab-1776597869252-rmr6v', 'screen-1776597528025', 'Otros Datos', 0, '"2026-04-19T11:24:29.253Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "screen_id" = EXCLUDED."screen_id", "name" = EXCLUDED."name", "tab_order" = EXCLUDED."tab_order", "created_at" = EXCLUDED."created_at";
INSERT INTO public.screen_tabs ("id", "screen_id", "name", "tab_order", "created_at")
VALUES ('tab-1776597942109-kp50z', 'screen-1776597053411', 'Otros Datos', 0, '"2026-04-19T11:25:42.115Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "screen_id" = EXCLUDED."screen_id", "name" = EXCLUDED."name", "tab_order" = EXCLUDED."tab_order", "created_at" = EXCLUDED."created_at";
INSERT INTO public.screen_tabs ("id", "screen_id", "name", "tab_order", "created_at")
VALUES ('tab-auto-1776599735697-xcqsz', 'screen-default', 'General', 0, '"2026-04-19T11:55:35.698Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "screen_id" = EXCLUDED."screen_id", "name" = EXCLUDED."name", "tab_order" = EXCLUDED."tab_order", "created_at" = EXCLUDED."created_at";
INSERT INTO public.screen_tabs ("id", "screen_id", "name", "tab_order", "created_at")
VALUES ('tab-crm-account-general', 'sc-crm-account', 'General', 0, '"2026-05-27T11:45:14.339Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "screen_id" = EXCLUDED."screen_id", "name" = EXCLUDED."name", "tab_order" = EXCLUDED."tab_order", "created_at" = EXCLUDED."created_at";
INSERT INTO public.screen_tabs ("id", "screen_id", "name", "tab_order", "created_at")
VALUES ('tab-crm-opp-general', 'sc-crm-opportunity', 'General', 0, '"2026-05-27T11:45:14.339Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "screen_id" = EXCLUDED."screen_id", "name" = EXCLUDED."name", "tab_order" = EXCLUDED."tab_order", "created_at" = EXCLUDED."created_at";
INSERT INTO public.screen_tabs ("id", "screen_id", "name", "tab_order", "created_at")
VALUES ('tab-crm-contact-general', 'sc-crm-contact', 'General', 0, '"2026-05-28T10:20:13.511Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "screen_id" = EXCLUDED."screen_id", "name" = EXCLUDED."name", "tab_order" = EXCLUDED."tab_order", "created_at" = EXCLUDED."created_at";
...
VALUES ('ctx-crm-cf_vat_cif-account', 'cf_vat_cif', 'proj-crm', 'account', '"2026-05-26T15:01:24.689Z"'::jsonb)
...
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_contact_person-account', 'cf_contact_person', 'proj-crm', 'account', '"2026-05-26T15:01:24.692Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_contact_phone-account', 'cf_contact_phone', 'proj-crm', 'account', '"2026-05-26T15:01:24.694Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_website-account', 'cf_website', 'proj-crm', 'account', '"2026-05-26T15:01:24.695Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_industry-account', 'cf_industry', 'proj-crm', 'account', '"2026-05-26T15:01:24.696Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_company_size-account', 'cf_company_size', 'proj-crm', 'account', '"2026-05-26T15:01:24.697Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_original_amount-opportunity', 'cf_original_amount', 'proj-crm', 'opportunity', '"2026-05-26T15:01:24.698Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_opportunity_currency-opportunity', 'cf_opportunity_currency', 'proj-crm', 'opportunity', '"2026-05-26T15:01:24.699Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_amount_in_base_currency-opportunity', 'cf_amount_in_base_currency', 'proj-crm', 'opportunity', '"2026-05-26T15:01:24.701Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_close_probability-opportunity', 'cf_close_probability', 'proj-crm', 'opportunity', '"2026-05-26T15:01:24.702Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_estimated_close_date-opportunity', 'cf_estimated_close_date', 'proj-crm', 'opportunity', '"2026-05-26T15:01:24.703Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_email-account', 'cf_email', 'proj-crm', 'account', '"2026-05-27T15:23:11.434Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_logo-account', 'cf_logo', 'proj-crm', 'account', '"2026-05-27T15:23:11.436Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_contact_email-contact', 'cf_contact_email', 'proj-crm', 'contact', '"2026-05-28T10:20:13.500Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_contact_phone-contact', 'cf_contact_phone', 'proj-crm', 'contact', '"2026-05-28T10:20:13.503Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_contact_accepted_terms-contact', 'cf_contact_accepted_terms', 'proj-crm', 'contact', '"2026-05-28T10:20:13.504Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_contact_accepted_marketing-contact', 'cf_contact_accepted_marketing', 'proj-crm', 'contact', '"2026-05-28T10:20:13.505Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_contact_create_portal_user-contact', 'cf_contact_create_portal_user', 'proj-crm', 'contact', '"2026-05-28T10:20:13.506Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_contact_email_sent-contact', 'cf_contact_email_sent', 'proj-crm', 'contact', '"2026-05-28T10:20:13.507Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_contact_personal_email-contact', 'cf_contact_personal_email', 'proj-crm', 'contact', '"2026-05-28T11:02:02.368Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_contact_department-contact', 'cf_contact_department', 'proj-crm', 'contact', '"2026-05-28T11:02:02.370Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_contact_job_profile-contact', 'cf_contact_job_profile', 'proj-crm', 'contact', '"2026-05-28T11:02:02.371Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_contact_job_title-contact', 'cf_contact_job_title', 'proj-crm', 'contact', '"2026-05-28T11:02:02.372Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_contact_seniority-contact', 'cf_contact_seniority', 'proj-crm', 'contact', '"2026-05-28T11:02:02.374Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_contact_address-contact', 'cf_contact_address', 'proj-crm', 'contact', '"2026-05-28T11:02:02.375Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_account_address-account', 'cf_account_address', 'proj-crm', 'account', '"2026-05-28T11:02:02.376Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_contact_country-contact', 'cf_contact_country', 'proj-crm', 'contact', '"2026-05-28T11:02:02.377Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_field_contexts ("id", "field_id", "project_id", "issue_type_id", "created_at")
VALUES ('ctx-crm-cf_account_country-account', 'cf_account_country', 'proj-crm', 'account', '"2026-05-28T11:02:02.378Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "field_id" = EXCLUDED."field_id", "project_id" = EXCLUDED."project_id", "issue_type_id" = EXCLUDED."issue_type_id", "created_at" = EXCLUDED."created_at";
...
VALUES ('cf_vat_cif', 'VAT / CIF', 'cf_vat_cif', 'text', 'Company Tax ID', '[]'::jsonb, FALSE, FALSE, '"2026-05-26T15:01:24.676Z"'::jsonb)
...
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_contact_person', 'Contact Person', 'cf_contact_person', 'text', 'Main Contact Name', '[]'::jsonb, FALSE, FALSE, '"2026-05-26T15:01:24.678Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_contact_phone', 'Contact Phone', 'cf_contact_phone', 'text', 'Contact Phone Number', '[]'::jsonb, FALSE, FALSE, '"2026-05-26T15:01:24.679Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_website', 'Website', 'cf_website', 'url', 'Company Website URL', '[]'::jsonb, FALSE, FALSE, '"2026-05-26T15:01:24.681Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_industry', 'Industry', 'cf_industry', 'select', 'Company Industry/Sector', '["Technology","Finance","Services","Health","Retail","Other"]'::jsonb, FALSE, FALSE, '"2026-05-26T15:01:24.682Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_company_size', 'Company Size', 'cf_company_size', 'select', 'Total Employees', '["1-10","11-50","51-200","201+"]'::jsonb, FALSE, FALSE, '"2026-05-26T15:01:24.683Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_original_amount', 'Original Amount', 'cf_original_amount', 'number', 'Deal original amount', '[]'::jsonb, FALSE, FALSE, '"2026-05-26T15:01:24.684Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_opportunity_currency', 'Opportunity Currency', 'cf_opportunity_currency', 'select', 'Deal currency', '["EUR","USD","GBP","MXN","JPY"]'::jsonb, FALSE, FALSE, '"2026-05-26T15:01:24.685Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_amount_in_base_currency', 'Amount in Base Currency', 'cf_amount_in_base_currency', 'number', 'Deal amount in corporate currency', '[]'::jsonb, FALSE, FALSE, '"2026-05-26T15:01:24.686Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_close_probability', 'Close Probability', 'cf_close_probability', 'select', 'Winning probability', '["10%","30%","50%","75%","90%","100%"]'::jsonb, FALSE, FALSE, '"2026-05-26T15:01:24.687Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_estimated_close_date', 'Estimated Close Date', 'cf_estimated_close_date', 'date', 'Expected closing date', '[]'::jsonb, FALSE, FALSE, '"2026-05-26T15:01:24.688Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_email', 'Company Email', 'cf_email', 'text', 'Company Email Address', '[]'::jsonb, FALSE, FALSE, '"2026-05-27T15:23:11.427Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_logo', 'Company Logo', 'cf_logo', 'url', 'Company Logo Image URL', '[]'::jsonb, FALSE, FALSE, '"2026-05-27T15:23:11.429Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_contact_email', 'Email del Contacto', 'cf_contact_email', 'text', 'Correo electrónico del contacto', '[]'::jsonb, FALSE, FALSE, '"2026-05-28T10:20:13.490Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_contact_accepted_terms', 'Acepta Términos', 'cf_contact_accepted_terms', 'checkbox', 'Acepta los términos y condiciones de la compañía', '[]'::jsonb, FALSE, FALSE, '"2026-05-28T10:20:13.492Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_contact_accepted_marketing', 'Acepta Comunicaciones', 'cf_contact_accepted_marketing', 'checkbox', 'Acepta envíos de comunicaciones comerciales', '[]'::jsonb, FALSE, FALSE, '"2026-05-28T10:20:13.493Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_contact_create_portal_user', 'Crear Usuario Portal', 'cf_contact_create_portal_user', 'checkbox', 'Indica si se debe dar de alta al contacto como usuario del portal', '[]'::jsonb, FALSE, FALSE, '"2026-05-28T10:20:13.494Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_contact_email_sent', 'Email Consentimiento Enviado', 'cf_contact_email_sent', 'checkbox', 'Indica si ya se envió el email de consentimiento', '[]'::jsonb, FALSE, FALSE, '"2026-05-28T10:20:13.495Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_contact_personal_email', 'Email Personal', 'cf_contact_personal_email', 'text', 'Correo electrónico personal del contacto', '[]'::jsonb, FALSE, FALSE, '"2026-05-28T11:02:02.350Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_contact_department', 'Departamento', 'cf_contact_department', 'text', 'Departamento del contacto', '[]'::jsonb, FALSE, FALSE, '"2026-05-28T11:02:02.351Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_contact_job_profile', 'Perfil Profesional', 'cf_contact_job_profile', 'select', 'Perfil profesional o rol del contacto', '["Agile Coach","Analista Big Data","Analista Funcional","Arquitecto Big Data","Arquitecto de datos","Arquitecto Java","Arquitecto Microservicios","Chief Scrum Master","Comercial","Data Governance","Data Quality","Data Science","DBA","Desarrollador Big Data","Desarrollador Java","Desarrollador Microservicios","Devops","Digital Market Consultant","Documentación","DPO","Financiero","Front End","Fullstack","Marketing/Comunicación","Office manager","People","Preventa","Product Owner","QA","Scrum Master","Service Delivery","sysDev","Technical Lead","Técnico de Seguridad","Técnico de Sistemas","Técnico de Soporte","Técnico informática interna","Técnico microinformática","UX"]'::jsonb, FALSE, FALSE, '"2026-05-28T11:02:02.352Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_contact_job_title', 'Cargo', 'cf_contact_job_title', 'text', 'Cargo o título profesional', '[]'::jsonb, FALSE, FALSE, '"2026-05-28T11:02:02.353Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_contact_seniority', 'Seniority', 'cf_contact_seniority', 'select', 'Nivel de seniority del contacto', '["Analyst","CEO/President/Owner","C-level","Consultant","Director-level","Individual contributor","Manager-level","Partner","VP-level","Other"]'::jsonb, FALSE, FALSE, '"2026-05-28T11:02:02.354Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_contact_address', 'Dirección del Contacto', 'cf_contact_address', 'text', 'Dirección física del contacto', '[]'::jsonb, FALSE, FALSE, '"2026-05-28T11:02:02.355Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_account_address', 'Dirección de la Cuenta', 'cf_account_address', 'text', 'Dirección física de la cuenta', '[]'::jsonb, FALSE, FALSE, '"2026-05-28T11:02:02.356Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_contact_country', 'País del Contacto', 'cf_contact_country', 'select', 'País de residencia del contacto', '["Afganistán","Albania","Alemania","Andorra","Angola","Antigua y Barbuda","Arabia Saudita","Argelia","Argentina","Armenia","Australia","Austria","Azerbaiyán","Bahamas","Bangladés","Barbados","Baréin","Bélgica","Belice","Benín","Bielorrusia","Birmania","Bolivia","Bosnia y Herzegovina","Botsuana","Brasil","Brunéi","Bulgaria","Burkina Faso","Burundi","Bután","Cabo Verde","Camboya","Camerún","Canadá","Catar","Chad","Chile","China","Chipre","Ciudad del Vaticano","Colombia","Comoras","Corea del Norte","Corea del Sur","Costa de Marfil","Costa Rica","Croacia","Cuba","Dinamarca","Dominica","Ecuador","Egipto","El Salvador","Emiratos Árabes Unidos","Eritrea","Eslovaquia","Eslovenia","España","Estados Unidos","Estonia","Etiopía","Filipinas","Finlandia","Fiyi","Francia","Gabón","Gambia","Georgia","Ghana","Granada","Grecia","Guatemala","Guyana","Guinea","Guinea Ecuatorial","Guinea-Bisáu","Haití","Honduras","Hungría","India","Indonesia","Irak","Irán","Irlanda","Islandia","Islas Marshall","Islas Salomón","Israel","Italia","Jamaica","Japón","Jordania","Kazajistán","Kenia","Kirguistán","Kiribati","Kuwait","Laos","Lesoto","Letonia","Líbano","Liberia","Libia","Liechtenstein","Lituania","Luxemburgo","Macedonia del Norte","Madagascar","Malasia","Malaui","Maldivas","Malí","Malta","Marruecos","Mauricio","Mauritania","México","Micronesia","Moldavia","Mónaco","Mongolia","Montenegro","Mozambique","Namibia","Nauru","Nepal","Nicaragua","Níger","Nigeria","Noruega","Nueva Zelanda","Omán","Países Bajos","Pakistán","Palaos","Panamá","Papúa Nueva Guinea","Paraguay","Perú","Polonia","Portugal","Reino Unido","República Centroafricana","República Checa","República del Congo","República Democrática del Congo","República Dominicana","Ruanda","Rumania","Rusia","Samoa","San Cristóbal y Nieves","San Marino","San Vicente y las Granadinas","Santa Lucía","Santo Tomé y Príncipe","Senegal","Serbia","Seychelles","Sierra Leona","Singapur","Siria","Somalia","Sri Lanka","Suazilandia","Sudáfrica","Sudán","Sudán del Sur","Suecia","Suiza","Surinam","Tailandia","Taiwán","Tanzania","Tayikistán","Timor Oriental","Togo","Tonga","Trinidad y Tobago","Túnez","Turkmenistán","Turquía","Tuvalu","Ucrania","Uganda","Uruguay","Uzbekistán","Vanuatu","Venezuela","Vietnam","Yemen","Yibuti","Zambia","Zimbabue"]'::jsonb, FALSE, FALSE, '"2026-05-28T11:02:02.357Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";
INSERT INTO public.custom_fields ("id", "name", "field_key", "field_type", "description", "options", "is_required", "is_system", "created_at")
VALUES ('cf_account_country', 'País de la Cuenta', 'cf_account_country', 'select', 'País de registro de la cuenta', '["Afganistán","Albania","Alemania","Andorra","Angola","Antigua y Barbuda","Arabia Saudita","Argelia","Argentina","Armenia","Australia","Austria","Azerbaiyán","Bahamas","Bangladés","Barbados","Baréin","Bélgica","Belice","Benín","Bielorrusia","Birmania","Bolivia","Bosnia y Herzegovina","Botsuana","Brasil","Brunéi","Bulgaria","Burkina Faso","Burundi","Bután","Cabo Verde","Camboya","Camerún","Canadá","Catar","Chad","Chile","China","Chipre","Ciudad del Vaticano","Colombia","Comoras","Corea del Norte","Corea del Sur","Costa de Marfil","Costa Rica","Croacia","Cuba","Dinamarca","Dominica","Ecuador","Egipto","El Salvador","Emiratos Árabes Unidos","Eritrea","Eslovaquia","Eslovenia","España","Estados Unidos","Estonia","Etiopía","Filipinas","Finlandia","Fiyi","Francia","Gabón","Gambia","Georgia","Ghana","Granada","Grecia","Guatemala","Guyana","Guinea","Guinea Ecuatorial","Guinea-Bisáu","Haití","Honduras","Hungría","India","Indonesia","Irak","Irán","Irlanda","Islandia","Islas Marshall","Islas Salomón","Israel","Italia","Jamaica","Japón","Jordania","Kazajistán","Kenia","Kirguistán","Kiribati","Kuwait","Laos","Lesoto","Letonia","Líbano","Liberia","Libia","Liechtenstein","Lituania","Luxemburgo","Macedonia del Norte","Madagascar","Malasia","Malaui","Maldivas","Malí","Malta","Marruecos","Mauricio","Mauritania","México","Micronesia","Moldavia","Mónaco","Mongolia","Montenegro","Mozambique","Namibia","Nauru","Nepal","Nicaragua","Níger","Nigeria","Noruega","Nueva Zelanda","Omán","Países Bajos","Pakistán","Palaos","Panamá","Papúa Nueva Guinea","Paraguay","Perú","Polonia","Portugal","Reino Unido","República Centroafricana","República Checa","República del Congo","República Democrática del Congo","República Dominicana","Ruanda","Rumania","Rusia","Samoa","San Cristóbal y Nieves","San Marino","San Vicente y las Granadinas","Santa Lucía","Santo Tomé y Príncipe","Senegal","Serbia","Seychelles","Sierra Leona","Singapur","Siria","Somalia","Sri Lanka","Suazilandia","Sudáfrica","Sudán","Sudán del Sur","Suecia","Suiza","Surinam","Tailandia","Taiwán","Tanzania","Tayikistán","Timor Oriental","Togo","Tonga","Trinidad y Tobago","Túnez","Turkmenistán","Turquía","Tuvalu","Ucrania","Uganda","Uruguay","Uzbekistán","Vanuatu","Venezuela","Vietnam","Yemen","Yibuti","Zambia","Zimbabue"]'::jsonb, FALSE, FALSE, '"2026-05-28T11:02:02.360Z"'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name", "field_key" = EXCLUDED."field_key", "field_type" = EXCLUDED."field_type", "description" = EXCLUDED."description", "options" = EXCLUDED."options", "is_required" = EXCLUDED."is_required", "is_system" = EXCLUDED."is_system", "created_at" = EXCLUDED."created_at";

-- 19. TABLEROS (BOARDS)
INSERT INTO public.boards ("id", "project_id", "name", "board_type", "pjql_filter", "created_at", "card_fields")
VALUES ('board-1777885973981', 'p-pf', 'PF_Scrum', 'scrum', 'project = "ProjectFlow Core"', '"2026-05-04T09:12:53.996Z"'::jsonb, '{}'::jsonb)
...
INSERT INTO public.boards ("id", "project_id", "name", "board_type", "pjql_filter", "created_at", "card_fields")
VALUES ('board-crm', 'proj-crm', 'CRM Board', 'kanban', 'project = "CRM"', '"2026-05-26T15:02:21.281Z"'::jsonb, '[]'::jsonb)
ON CONFLICT ("id") DO UPDATE SET "project_id" = EXCLUDED."project_id", "name" = EXCLUDED."name", "board_type" = EXCLUDED."board_type", "pjql_filter" = EXCLUDED."pjql_filter", "created_at" = EXCLUDED."created_at", "card_fields" = EXCLUDED."card_fields";
