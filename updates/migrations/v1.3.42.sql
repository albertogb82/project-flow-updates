-- Migración acumulativa para la versión 1.3.42 (2026-07-05)
-- Basada en la migración previa de la versión 1.3.42

-- Migración acumulativa para la versión 1.3.42 (2026-07-05)
-- Basada en la migración previa de la versión 1.3.41

-- Migración acumulativa para la versión 1.3.41 (2026-07-01)
-- Basada en la migración previa de la versión 1.3.40

-- Migración acumulativa para la versión 1.3.40 (2026-06-21)
-- Basada en la migración previa de la versión 1.3.39

-- Migración acumulativa para la versión 1.3.39 (2026-06-21)
-- Basada en la migración previa de la versión 1.3.38

-- Migración acumulativa para la versión 1.3.38 (2026-06-21)
-- Basada en la migración previa de la versión 1.3.37

-- Migración acumulativa para la versión 1.3.37 (2026-06-21)
-- Basada en la migración previa de la versión 1.3.36

-- Migración acumulativa para la versión 1.3.36 (2026-06-21)
-- Basada en la migración previa de la versión 1.3.35

-- Migración acumulativa para la versión 1.3.35 (2026-06-21)
-- Basada en la migración previa de la versión 1.3.34
...
-- [NUEVOS CAMBIOS PARA LA VERSIÓN 1.3.35] --
-- Drop the foreign key constraint on account_id in public.sla_configurations
ALTER TABLE public.sla_configurations DROP CONSTRAINT IF EXISTS sla_configurations_account_id_fkey;
...
-- [NUEVOS CAMBIOS PARA LA VERSIÓN 1.3.36] --
-- Drop the foreign key constraint on account_id in public.sla_configurations
ALTER TABLE public.sla_configurations DROP CONSTRAINT IF EXISTS sla_configurations_account_id_fkey;
...
-- [NUEVOS CAMBIOS PARA LA VERSIÓN 1.3.37] --
-- Drop the foreign key constraint on account_id in public.sla_configurations
ALTER TABLE public.sla_configurations DROP CONSTRAINT IF EXISTS sla_configurations_account_id_fkey;
...
-- [NUEVOS CAMBIOS PARA LA VERSIÓN 1.3.38] --
-- Drop the foreign key constraint on account_id in public.sla_configurations
ALTER TABLE public.sla_configurations DROP CONSTRAINT IF EXISTS sla_configurations_account_id_fkey;
...
-- [NUEVOS CAMBIOS PARA LA VERSIÓN 1.3.39] --
-- Drop the foreign key constraint on account_id in public.sla_configurations
ALTER TABLE public.sla_configurations DROP CONSTRAINT IF EXISTS sla_configurations_account_id_fkey;
...
-- [NUEVOS CAMBIOS PARA LA VERSIÓN 1.3.40] --
-- Drop the foreign key constraint on account_id in public.sla_configurations
ALTER TABLE public.sla_configurations DROP CONSTRAINT IF EXISTS sla_configurations_account_id_fkey;
...
-- [NUEVOS CAMBIOS PARA LA VERSIÓN 1.3.41] --
...
-- [NUEVOS CAMBIOS PARA LA VERSIÓN 1.3.42] --
